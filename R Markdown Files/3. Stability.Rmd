...
```{r}
week_rank <- read.csv("/Users/justinvarholick/Documents/GitHub/AcomysDominance_2023/Data/dscorebweek_edited.csv")
...
dumcage <- read.csv("/Users/justinvarholick/Documents/GitHub/AcomysDominance_2023/Data/dscorebyanimal_edited.csv")
...
cumm_dom <- read.csv("/Users/justinvarholick/Documents/GitHub/AcomysDominance_2023/Data/dscorebyanimal_edited.csv")
...
```
```{r}
DumCage <- c("A", "B", "C", "D", "E", "F", "G", "H", "I", "J", "K", "L")
stability <- c("S+IF", "D+F", "S+F", "S+IF", "S+F", "S+F", "D+F", "S+IF", "S+F", "Unm", "Unm", "Unm")
...
stability_data$stability <- factor(stability_data$stability, levels=c("S+F","D+F","S+IF","Unm"))
```
```{r}
...
ggsave("/Users/justinvarholick/Documents/GitHub/AcomysDominance_2023/Figures/Fig2_stab_plot.png", fig2.2, units="in", width = 9, height = 6, device='png', dpi=300)
```
```{r}
